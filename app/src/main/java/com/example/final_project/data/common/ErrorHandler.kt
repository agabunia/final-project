...
sealed class ErrorHandler {
    data class UserAlreadyExistsFailure(val message: String = "The User Already Exists") : ErrorHandler()
    data class IncorrectCredentialFailure(val message: String = "Incorrect Email/Password"): ErrorHandler()
